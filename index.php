    ...
    <header class="header" data-header>
      <div class="container">
        ...
        <div class="header-actions">
          <a href="school.php" class="btn has-before btb" class="row-button" target="_blank">
            <span class="span">Schools</span>
          </a>

          <a href="Educators/Educators.php" class="btn has-before btb" class="row-button">
            <span class="span">Educators</span>
          </a>

          <a href="login.php" class="btn has-before btb" class="row-button" target="_blank">
    ...
    <main>
          ...
          <div class="container">
            ...
            <div class="hero-content">
              ...
              <div class="Expolre">
                ...
                <a href="Educators/Educators.php" class="btb has-before" class="row-button">
                  <span class="span">Educators</span>
                </a>
      ...
      -->
        ...
        <section class="sectio categor" aria-label="category" id="top-skills">
            ...
            <ul class="grid-list">
              ...
              <li>
                <div class="category-car card-1">
                  ...
                  <div>
                    <h3 class="h3 card">
                      <a href="courses/artificial.php">Artificial Intelligence</a>
                    </h3>
              ...
              <li>
                <div class="category-car">
                  ...
                  <div>
                    <h3 class="h3 card">
                      <a href="login.php">Machine Learning</a>
                    </h3>
              ...
              <li>
                <div class="category-car">
                  ...
                  <div>
                    <h3 class="h3 card">
                      <a href="login.php">Data Mining</a>
                    </h3>
              ...
              <li>
                <div class="category-car">
                  ...
                  <div>
                    <h3 class="h3 card">
                      <a href="login.php">Natural Language Processing</a>
                    </h3>
              ...
              <li>
                <div class="category-car">
                  ...
                  <div>
                    <h3 class="h3 card">
                      <a href="login.php">Data Analytics With Python</a>
                    </h3>
              ...
              <li>
                <div class="category-car">
                  ...
                  <div>
                    <h3 class="h3 card">
                      <a href="login.php">Data Strucure & Algoritham</a>
                    </h3>
              ...
              <li>
                <div class="category-car">
                  ...
                  <div>
                    <h3 class="h3 card">
                      <a href="login.php">Internet Of Things</a>
                    </h3>
          ...
          <div class="button">
            <a href="courses/course-grid.php">More Courses</a>
          </div>
        </section>
        ...
        <section class="section about" id="about" aria-label="about">
          <div class="container">
            ...
            <div class="about-content">
              ...
              <h2 class="h2 section-title">
                Transforming Education for the <span class="span">21st Century School </span> with Industry 4.0 Technologies
              </h2>
              ...
              <li>
                <div class="blog-card">
                  ...
                  <div class="card-content">
                    ...
                    <a href="news/news.php" class="card-btn" aria-label="read more" id="subscribeButton">
                      <ion-icon name="arrow-forward-outline" aria-hidden="true"></ion-icon>
                    </a>

                    <a href="news/news.php" class="card-subtitle">Online</a>

                    <h3 class="h3" id="popUpNewsForm">
                      <a href="news/news.php" class="card-title">Robotics Summer Camp a Resounding Success at St.
                        Joseph's
                        School.!</a>
                    </h3>
              ...
              <li>
                <div class="blog-card">
                  ...
                  <div class="card-content">
                    ...
                    <a href="news/news.php" class="card-btn" aria-label="read more">
                      <ion-icon name="arrow-forward-outline" aria-hidden="true"></ion-icon>
                    </a>
                    ...
                    <h3 class="h3">
                      <a href="news/news.php" id="openLoginFormBtn" class="card-title">Robotics Summer Camp at IRIS
                        Crown School
              ...
              <li>
                <div class="blog-card">
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="news/news.php" class="card-title">High School Student Develops Innovative 'Dog Robot' for
                        Science
                        Fair Project.</a>
                    </h3>
      ...
      <section class="Free">
        <div class="flex-workshop">
          ...
          <div class="flex-item-right">
            <div><img class="image-meeting" src="assets/images/Deconstructed robot-amico.png" alt="image"></div>
          </div>
      </section>
        ...
        <div class="container grid-list">
          ...
          <div class="footer-brand">
            ...
            <div class="wrapper">
              ...
              <a href="mailto:info@naivotech.com" class="footer-link">info@vilab.co.in</a>
            </div>
          ...
          <div class="footer-list">
            ...
            <div id="success-Message" class="success-message" style="display:none;">You have successfully subscribed to
              the newsletter!</div>
...
========================================-->
  ...
  <div class="fixed-button">
    ...
    <a class="fixed-btn" aria-label="Chat on WhatsApp" href="https://wa.me/919653006686">
